...
use Zend\View\Assets\AssetsListener;
...
class AssetsListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    */
        ...
        if (!$this->serviceManager) {
            $this->serviceManager = new ServiceManager([
                ...
                'factories' => [
                    ...
                    'AssetsListener'     => 'Zend\View\Assets\Service\AssetsListenerFactory',
                    'Assets'             => 'Zend\View\Assets\Helper\Service\AssetsFactory',
    ...
    protected function prepareAssetToMvcEvent($asset)
    {
        ...
        $this->assetsListener->injectRouter($mvcEvent);
    ...
    public function testSetRouter()
    {
        ...
        $this->setExpectedException(
            ...
            'Zend\View\Assets\AssetsListener::setRouter: expects parameter an array or Zend\Router\RouteInterface, received "stdClass"'
        );
